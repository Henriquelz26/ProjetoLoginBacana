...
public class CadastroUsuarioModel extends LoginModel {
    ...
    public void resetSenhaBDModel(CadastroUsuarioModel senhaAtualizada){
        GerenciadorBancoDados op = new GerenciadorBancoDados();
        op.resetSenha(senhaAtualizada);
    }
    
     public ArrayList<CadastroUsuarioModel> recuperarUsuarioModel(String id_user) {
        GerenciadorBancoDados oper = new GerenciadorBancoDados();
        return oper.recuperarUsuariosBD(id_user);
    }
